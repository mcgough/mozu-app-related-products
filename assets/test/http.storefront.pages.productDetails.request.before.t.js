...
var actionName = 'http.storefront.pages.productDetails.request.before';

describe('http.storefront.pages.productDetails.request.before implementing http.storefront.pages.productDetails.request.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.productDetails.request.before');
  });
